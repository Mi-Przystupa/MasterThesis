...
\begin{figure}
	...
	\caption{Graphical models of \ac{LVNMT} models we consider. Left is the discriminative formulation and the Right is the joint or generative formulation. Dashed lines represent the variational distribution, solid lines are the model.}

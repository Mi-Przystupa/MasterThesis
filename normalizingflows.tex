...
\end{equation} 
Intuitively, this transformation can be seen as contracting or expanding the samples $z$ along a single line in space. This is a simple transformation and requires many planar flows to represent complicated distributions. This need for more flows to effectively transform the distribution space makes them less desirable compared to other flows.  %In the experiments of \citet{rezende2015VIwithNF} they required at least 32 flows before accurately recovering the posterior distributions.

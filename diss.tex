...
\examiningcommittee{Muhammad Abdul-Mageed, Linguistics and Information Science}{Co-supervisor}
...
%% files
\hypersetup{
  pdftitle={Investigating the Impact of Normalizing Flows on Latent Variable Machine Translation},
  pdfauthor={Michael Przystupa},
  pdfkeywords={machine translation, NMT, latent variables, normalizing flows}
}
...
\include{background}
%\include{relatedwork}%separate into LVNMT & normalizing flows
\include{LVNMT}
\include{normalizingflows}
\include{experiments}
%\include{discussion}
\include{conclusion}
